...
- [spartan-core](https://github.com/SpartanSystems/spartan-core) - Core AI framework
- [SpartanForge](https://github.com/SpartanSystems/SpartanForge) - Kubernetes deployment
